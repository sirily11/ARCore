 ...
 * resolve multiple anchors at a time, but a session cannot be tracking more than 40 Terrain Anchors
 * at time. Attempting to resolve more than 40 Terrain Anchors will result in
